...
public class tableActivity extends AppCompatActivity {
    ...
    public void init() {
        ...
        tv2.setText(" RFID Number ");
        tv2.setTextColor(Color.WHITE);
        tbrow0.addView(tv2);
        TextView tv3 = new TextView(this);
        tv3.setText(" Age Code ");
        tv3.setTextColor(Color.WHITE);
        tbrow0.addView(tv3);
        TextView tv4 = new TextView(this);
        tv4.setText(" Sex Code ");
        tv4.setTextColor(Color.WHITE);
        tbrow0.addView(tv4);
        stk.addView(tbrow0);

        for (int counter = 0; counter <= row; counter ++) {
            String bandString = arrayReceived[counter][0];
            String beeString = arrayReceived[counter][1];
            String rfidString = arrayReceived[counter][2];
            String ageString = arrayReceived[counter][3];
            String sexString = arrayReceived[counter][4];

            String[] ageSplit = ageString.split(" ");
            TableRow tbrow = new TableRow(this);
            TextView t1v = new TextView(this);
            t1v.setText(bandString);
            t1v.setTextColor(Color.WHITE);
            t1v.setGravity(Gravity.CENTER);
            tbrow.addView(t1v);
            TextView t2v = new TextView(this);
            t2v.setText(beeString);
            t2v.setTextColor(Color.WHITE);
            t2v.setGravity(Gravity.CENTER);
            tbrow.addView(t2v);
            TextView t3v = new TextView(this);
            t3v.setText(rfidString);
            t3v.setTextColor(Color.WHITE);
            t3v.setGravity(Gravity.CENTER);
            tbrow.addView(t3v);
            TextView t4v = new TextView(this);
            t4v.setText(ageSplit[0]);
            t4v.setTextColor(Color.WHITE);
            t4v.setGravity(Gravity.CENTER);
            tbrow.addView(t4v);
            TextView t5v = new TextView(this);
            t5v.setText(sexString);
